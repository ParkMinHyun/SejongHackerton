...
//    private SpotsDbAdapter spotDbAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        subjects=Arrays.asList("EnglishListeningPractice1","EnglishListeningPractice2","EnglishWriting1","EnglishWriting2","TechnicalWriting기초");
...
//        final AlertDialog.Builder builder = new AlertDialog.Builder(AccreditInfoActivity.mContextTourInfo);
//        key = position;
//
//        if (mode.equals("GPS")) {
...
//        this.spotDbAdapter = new SpotsDbAdapter(AccreditInfoActivity.mContextTourInfo);
//        spotDbAdapter.open();
...
//        tmaptapi = new TMapTapi(AccreditInfoActivity.mContextTourInfo);
...
//                Log.i("키인증", "실패");
//                Toast.makeText(AccreditInfoActivity.mContextTourInfo, getString(R.string.navigationError), Toast.LENGTH_LONG).show();
//            }
//        });
//    }
//
...
//
//        telephonyManager = (TelephonyManager) AccreditInfoActivity.mContextTourInfo.getSystemService(Context.TELEPHONY_SERVICE);
//        networkoper = telephonyManager.getNetworkOperatorName();
//
//        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
//                AccreditInfoActivity.mContextTourInfo);
//
//        alertDialogBuilder
